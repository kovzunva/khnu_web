...
class CommentService extends BaseItemService 
{
    ...
    public function GetChat($work_id, Request $request = null, bool $paginate = true, $per_page = self::PER_PAGE_BASE){
    ...
    public function GetChatFilters($work_id, Request $request){
        $filter = new \stdClass();
